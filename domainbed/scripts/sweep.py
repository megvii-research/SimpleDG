...
class Job:
    ...
    def __init__(self, train_args, sweep_output_dir):
        ...
        hparams = json.loads(train_args['hparams'])
        args_hash = '{}-{}-bs{}-lr{}-wd{}'.format(
            train_args['dataset'],
...
def make_args_list(n_trials, dataset_names, algorithms, pretrain_path, n_hparams_from, n_hparams, steps,
            ...
            for batch_size in [32]:
                for lr in [5e-4, 1e-3, 1e-2]:
                    for weight_decay in [1e-2, 1e-3, 1e-4]:
                        ...
                        train_args['pretrain_path'] = pretrain_path
                        ...
                        train_args['hparams'] = json.dumps(hparams)
