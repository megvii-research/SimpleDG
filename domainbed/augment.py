...
class FMix(FMixBase):
        ...
        .. code-block:: python
            ...
            class FMixExp(pl.LightningModule):
                ...
                def training_step(self, batch, batch_idx):
                    ...
                    return loss
    """
    def __init__(self, decay_power=3, alpha=1, size=(32, 32), num_classes=None, prob=1.0, max_soft=0.0, reformulate=False):
    ...
    def __call__(self, x, y):
        ...
        # Mix the labels
        y2 = y[index]
        y1 = F.one_hot(y, num_classes=self.num_classes)
        y2 = F.one_hot(y2, num_classes=self.num_classes)

        return x1 + x2, y1*lam + y2*(1 - lam)
...
class FMixup:
    def __init__(self, mixup_alpha=0.1, cutmix_alpha=1, fmix_alpha=1, label_smoothing=0.1, size=(224, 224), num_classes=1000):
        ...
        self.fmix = FMix(alpha=fmix_alpha, size=size, num_classes=num_classes)
